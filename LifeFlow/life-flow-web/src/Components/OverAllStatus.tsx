  ...
  return (
    <div className="stats shadow">
      <div className="stat">
        ...
        <div className="stat-desc">21% more in last month</div>
      </div>
      ...
      <div className="stat">
        ...
        <div className="stat-title">Life Saved</div>
        <div className="stat-value text-secondary">2.6M</div>
        <div className="stat-desc">0% casuality for insufficent blood</div>
      </div>
      ...
      <div className="stat">
        ...
        <div className="stat-desc text-secondary">Serving all over nation</div>
      </div>
    </div>
  );
};
