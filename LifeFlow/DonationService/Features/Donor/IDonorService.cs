...
public interface IDonorService
{
    ...
    /// <returns>
    ///     A <see cref="Task{DonorDto}" /> representing the asynchronous operation, with a <see cref="DonorDto" /> result
    ///     containing donor details.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task{List{DonorDto}}" /> representing the asynchronous operation, with a list of
    ///     <see cref="DonorDto" /> objects.
    /// </returns>
    ...
    /// <returns>
    ///     A <see cref="Task{List{DonorFetchDto}}" /> representing the asynchronous operation, with a list of
    ///     <see cref="DonorDto" /> objects.
    /// </returns>
    ...
    ///     <see cref="DonorDto" /> objects.
    /// </returns>
    Task<List<DonorFetchDto>> GetByLocationAndBloodType(double lat, double lon, AntigenType bloodType,
    ...
    /// <returns>
    ///     A <see cref="Task{DonorDto}" /> representing the asynchronous operation, with a <see cref="DonorDto" /> result
    ///     containing the deleted donor's details.
    /// </returns>
    ...
    /// <returns>
    ///     A <see cref="Task{DonorDto}" /> representing the asynchronous operation, with a <see cref="DonorDto" /> result
    ///     containing the added donor's details.
    /// </returns>
    ...
    /// <returns>
    ///     A <see cref="Task{DonorDto}" /> representing the asynchronous operation, with a <see cref="DonorDto" /> result
    ///     containing the updated donor's details.
    /// </returns>
