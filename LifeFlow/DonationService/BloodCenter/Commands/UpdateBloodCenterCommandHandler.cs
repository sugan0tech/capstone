...
public class UpdateBloodCenterCommandHandler(BloodCenterService bloodCenterService, IMediator mediator, ILogger<UpdateDonorCommandHandler> logger): IRequestHandler<UpdateBloodCenterCommand, BloodCenterDto>
{
